...
public class GateNetwork {
	String name;
	ArrayList<String> networkadmins = new ArrayList();
	ArrayList<String> networkmembers = new ArrayList();
	ArrayList<String> networkstargates = new ArrayList();
	String state = "public";
	...
	public ArrayList<GateNetwork> getNetworkList() {
		ArrayList<GateNetwork> networkList = new ArrayList();
		try {
			...
			e.printStackTrace();
			System.out.println("Konnte networkList.txt nicht finden!");
		}
	}
