...
public class Ringtransporter {
	Material RINGTRANSPORTER_MATERIAL = MCStargates.configValues.RingMaterial;
	byte RINGTRANSPORTER_MATERIAL_DATA = MCStargates.configValues.RingMaterial_data;
	Material RINGTRANSPORTER_GROUND_MATERIAL = MCStargates.configValues.RingGroundMaterial;
	byte RINGTRANSPORTER_GROUND_MATERIAL_DATA = MCStargates.configValues.RingGroundMaterial_data;
	...
	public Location getLocationNoOffset() {
		int offset = MCStargates.configValues.RingDistance;
	...
	public ArrayList<Entity> getEntitysInside() {
		ArrayList<Entity> allEntitys = new ArrayList();
	...
	public Vector getNormalVector() {
		...
		String direction = SignUtils.signFacing(s).getOppositeFace();
	...
	public ArrayList<Vector> ringshape() {
		...
		ArrayList<Vector> ringShapePositions = new ArrayList();
			...
			this.id = org.bukkit.Bukkit.getServer().getScheduler().scheduleSyncRepeatingTask(MCStargates.getInstance(),
					new Runnable() {
						public void run() {
							...
							ArrayList<Integer> animationFrame = new ArrayList();
	...
	public void transportBlocks() {
		...
		if (Ring2 != null) {
			...
			ArrayList<ItemStack[]> i1 = new ArrayList();
			...
			ArrayList<Location> tabulist = new ArrayList();
